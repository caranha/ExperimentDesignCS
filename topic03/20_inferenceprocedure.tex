...
\begin{frame}{Outline of the Procedure for the NHST}
  ...
  The overall procedure is to calculate the \structure{parameter estimate} for our parameter of interest, and see if this value falls into a \structure{Rejection Region}. An estimate that falls in this region leads us to reject the null hypothesis as {\bf unlikely.}
...
\begin{frame}{Outline of the Procedure for the NHST}{Inference Errors}
  Remember that the statistic that estimate a parameter is a {\bf random variable}. So there is an \structure{error} associated with the statistic, and we can reach \alert{wrong conclusions}.\bigskip
