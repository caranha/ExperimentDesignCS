...
x<-rnorm(n=50, mean=50, sd=2)   # Draw 25 samples from N(mu=50,sigma=2)
...
If we collect a large sample, our estimated error for the sample mean 
...
# TODO
- Write a function that shows that the average is a unbiased estimator (it counts the number of times that the average overestimates and underestimates, and maybe the magnitude as well)

- Write a function that plots how the sample error decreases as the sample size increases (this would indicate the rate of diminishing returns)
